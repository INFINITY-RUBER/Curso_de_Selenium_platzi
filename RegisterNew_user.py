...
class RegisterNewUser(unittest.TestCase):
    ...
    def test_new_user(self):
        ...
        self.assertTrue(create_account_button.is_displayed() and create_account_button.is_enabled()) # que el boton este visible y habilitado
        ...
        new_letter_subcript = driver.find_element_by_id('is_subscribed')
        ...
        and new_letter_subcript.is_enabled()
